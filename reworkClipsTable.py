                        ...
                        if message.item_type == None or message.is_sent_by_viewer == True:
                            ...
                            match message.item_type:
                                case "clip":
                                    ...
                                    # )
                                    print ( f"[{get_now()}] updating the clips table with new message {message_id}")
                            ...
                            print(f"[{get_now()}] Updated the clips table with new message {message_id}, {clip_code}")
